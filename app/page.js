...
{!showSearch && !selectedCategory && (
  <section className="container mx-auto px-4 py-8 text-sm leading-relaxed text-gray-800">
    ...
    <p>
      योगेश कृषी केंद्र, किंगाव (अहमदपूर, लातूर) येथे शेतकरी बांधवांच्या 
    ...
    <p className="mt-3">
      आमची सेवा किंगाव, अहमदपूर, लातूर आणि आसपासच्या ग्रामीण भागात 
      जलद व विश्वासार्ह आहे. “किंगावमधील सर्वोत्तम कृषी केंद्र”, 
      “अहमदपूरमध्ये खते कुठे मिळतील?”, “लातूरमध्ये बियाणे दुकान” 
      अशा शोधांसाठी योगेश कृषी केंद्र हे तुमचे जवळचे व विश्वासू दुकान आहे.
    </p>
    ...
    <p className="mt-3">
      ...
      नवीन उत्पादने, सवलती, आणि दर तपशील सहज पाहू शकता.
    </p>
  </section>
)}
