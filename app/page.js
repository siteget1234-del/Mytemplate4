...
{!showSearch && !selectedCategory && (
  <section className="container mx-auto px-4 py-8 text-sm leading-relaxed text-gray-800">
    <h2 className="text-lg font-semibold mb-2">आमच्याबद्दल</h2>

    <p>
      योगेश कृषी सेवा केंद्र, किनगाव (अहमदपूर, लातूर) हे शेतकरी बांधवांच्या 
      सर्व कृषी गरजांची एकच विश्वासू ठिकाण आहे. आमच्याकडे बियाणे, खते, 
      कीडनाशके, तणनाशके, शेतीसाठी आवश्यक औषधे, स्प्रे पंप, तसेच 
      आधुनिक कृषी संरक्षण साधने उपलब्ध आहेत.
    </p>

    <p className="mt-3">
      आमची सेवा किनगाव, अहमदपूर, लातूर आणि आसपासच्या ग्रामीण भागात 
      जलद व विश्वासार्ह आहे. “किंगावमधील सर्वोत्तम कृषी केंद्र”, “तसेच 
      अहमदपूर मधील पहिलेच डिजिटल कृषी सेवा केंद्र”
      “अहमदपूरमध्ये खते कुठे मिळतील?”, “लातूरमध्ये बियाणे दुकान” 
      अशा शोधांसाठी योगेश कृषी सेवा केंद्र हे तुमचे जवळचे व विश्वासू दुकान आहे.
    </p>

    <p className="mt-3">
      आम्ही शेतकऱ्यांना योग्य मार्गदर्शन, खरी उत्पादने आणि योग्य दरात 
      साहित्य देण्याचा नेहमी प्रयत्न करतो. आमच्या या वेबसाईटद्वारे आपण 
      नवीन उत्पादने, सवलती, आणि दर तपशील सहज पाहू शकता व घरबसल्या 
      उत्पादने खरेदी ही करू शकता.
    </p>
  </section>
)}
